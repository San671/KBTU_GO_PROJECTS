...
// The contextSetUser() retrieve the User struct from the request context. The only time that
// we'll use this helper is when we logically expect there to be User struct value in the context,
// and if it doesn't exist it will firmly be an unexpected error.
