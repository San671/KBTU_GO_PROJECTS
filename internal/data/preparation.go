...
var ErrInvalidPreparationFormat = errors.New("invalid runtime format")

type Preparation int32
...
func (r Preparation) MarshalJSON() ([]byte, error) {
...
// this method returns).
func (r *Preparation) UnmarshalJSON(jsonValue []byte) error {
	...
	if err != nil {
		return ErrInvalidPreparationFormat
	}
